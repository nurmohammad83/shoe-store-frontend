    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <Link href='/' className="text-white hover:text-gray-400">First Link</Link>
          </li>
          <li>
            <Link href='/' className="text-white hover:text-gray-400">Second Link</Link>
          </li>
          <li>
            <Link href='/' className="text-white hover:text-gray-400">Third Link</Link>
          </li>
          <li>
            <Link href='/' className="text-white hover:text-gray-400">Fourth Link</Link>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
